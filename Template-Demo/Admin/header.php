...
$mail_sorgula = $baglan->query("select * from kurumsal_email");
$mail_cek = mysqli_fetch_assoc($mail_sorgula);

$egitim_sorgula = $baglan->query("select * from egitim_sayfalari");
$egitim_cek = mysqli_fetch_assoc($egitim_sorgula);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>OTS Studio | Dashboard</title>
